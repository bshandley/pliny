    ...
    <div className="general-settings">
      ...
      <div className="settings-card">
        ...
        <div className="setting-row">
          ...
          <div className="password-input-wrapper" style={{ width: '220px' }}>
            <input
            ...
            />
            <button type="button" className="password-toggle" onClick={() => setShowSmtpPassword(v => !v)} tabIndex={-1} aria-label={showSmtpPassword ? 'Hide password' : 'Show password'}>
              {showSmtpPassword ? (
